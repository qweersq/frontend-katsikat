...
import CustomerFormAdd from "../../shoesManagement/CustomerFormAdd";
    ...
    return (
        <Box>
            ...
            <Box sx={{ width: '100%', display: 'flex', justifyContent: 'space-between', padding: '10px' }}>
                ...
                <Button onClick={handleDialogCS} variant="contained" sx={{ backgroundColor: colors.blueAccent[700] }}>
                    Add Customer
                </Button>
            </Box>
                                            ...
                                            {columns.map((column) => {
                                                ...
                                                return (
                                                    <TableCell key={column.id} align={column.align}>
                                                        ...
                                                        {column.id === 'action' ?
                                                            <div>
                                                                <ActionCustomer customerDataId={item.id} fetchCustomerData={fetchCustomerData} />
                                                            </div>
                                                            : null}
                                                    </TableCell>
                                                );
