...
const AddTransactionForm = ({ statusDialogTR, handleClickOpenDialogTR, fetchDashboardData, fetchDataShoesTransactionList }) => {
    ...
    const postApiNewTransaction = async () => {
        console.log("Post Api New Transaction")
    ...
    return (
        ...
        <Box>
            ...
            <Dialog open={statusDialogTR} onClose={handleClickOpenDialogTR}>
                <DialogTitle sx={{
                ...
                <DialogActions sx={{
                    ...
                    <Button onClick={handleClickOpenDialogTR} sx={{
                        backgroundColor: colors.blueAccent[800],
                        color: colors.primary[100],
                    }}>Cancel</Button>
                    <Button onClick={postApiNewTransaction} sx={{
                        backgroundColor: colors.blueAccent[800],
                        color: colors.primary[100],
                    }}>Submit</Button>
                </DialogActions>
